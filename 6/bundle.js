...
const showMoreFilm = () => {
  ...
  films
    ...
    .forEach((film) => {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(filmsContainer, new _view_film_js__WEBPACK_IMPORTED_MODULE_4__["default"](film).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
    });
...
const onPopupClose = (evt) => {
  if (evt.type === Event.KEY_DOWN) {
    if (evt.target.className === `film-details__close-btn`) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["checkButtonPress"])(evt, popupClose, Button.ENTER);
    } else {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["checkButtonPress"])(evt, popupClose, Button.ESCAPE);
    }
  } else if (evt.type === Event.MOUSE_DOWN) {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["checkButtonPress"])(evt, popupClose, Button.MOUSE_MAIN);
  }
};
...
const showDetailFilm = () => {
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(body, popupElement.element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
const onDetailFilmShow = (evt) => {
  if (evt.target.classList.contains(`film-card__poster`)
    ...
    if (evt.type === Event.KEY_DOWN) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["checkButtonPress"])(evt, showDetailFilm, Button.ENTER);
    } else if (evt.type === Event.MOUSE_DOWN) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["checkButtonPress"])(evt, showDetailFilm, Button.MOUSE_MAIN);
    }
  }
};
...
const renderAdditionalFilmBlocks = (container, sortedFilms) => {
  for (let i = 0; i < Math.min(sortedFilms.length, MAX_ADDITIONAL_FILMS); i++) {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(container, new _view_film_js__WEBPACK_IMPORTED_MODULE_4__["default"](sortedFilms[i]).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
  }
...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(header, new _view_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](stats).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"](filterData).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);

if (films.length) {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_sorting_js__WEBPACK_IMPORTED_MODULE_2__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_films_container_js__WEBPACK_IMPORTED_MODULE_3__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
} else {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_no_film__WEBPACK_IMPORTED_MODULE_8__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
}

Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(footerStatistics, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_7__["default"](TOTAL_FILMS).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
for (let i = 0; i < Math.min(films.length, MOVIES_PER_STEP); i++) {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(filmsContainer, new _view_film_js__WEBPACK_IMPORTED_MODULE_4__["default"](films[i]).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
if (TOTAL_FILMS > MOVIES_PER_STEP) {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_12__["render"])(filmList, loadMoreButtonElement.element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
