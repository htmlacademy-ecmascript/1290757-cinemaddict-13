...
/* harmony import */ var _model_film_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/film.js */ "./src/model/film.js");
...
class Api {
  ...
  addComment(data) {
    return this._load({
      ...
      method: Method.POST,
      body: JSON.stringify(_model_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentToServer(data.comment)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentToClient);
  }
  ...
  updateFilms(film) {
    return this._load({
      url: `/movies/${film.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptFilmToServer(film)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptFilmToClient);
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: PROPOSALS, ACTORS, MAX_DAYS, SECONDS_IN_MINUTE, RenderPosition, Event, Button, TOTAL_FILMS, SortType, UserAction, UpdateType, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _model_film_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/film.js */ "./src/model/film.js");
...
const filmsModel = new _model_film_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
api.getFilms()
  .then((films) => {
    filmsModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, films);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(header, new _view_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](films).element, _const_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFORE_END);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(footerStatistics, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](films.length).element, _const_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFORE_END);
  })
  .catch(() => {
    filmsModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, []);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(header, new _view_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFORE_END);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(footerStatistics, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFORE_END);
  });

const pageMainContentPresenter = new _presenter_page_main_content_js__WEBPACK_IMPORTED_MODULE_2__["default"](body, main, filmsModel, filterModel, api);
const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_3__["default"](main, filterModel, filmsModel);
...
class Filter {
  ...
  init() {
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent, _const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFORE_END);
      return;
    }
  ...
  _handleStatisticsClick() {
    ...
    this._filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].STATISTICS);
  }
...
/* harmony import */ var _view_no_film__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/no-film */ "./src/view/no-film.js");
...
/* harmony import */ var _view_stats_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/stats.js */ "./src/view/stats.js");
...
class PageMainContent {
  constructor(bodyContainer, mainContainer, filmsModel, filterModel, api) {
    ...
    this._filmsContainerView = new _view_films_container_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._noFilmView = new _view_no_film__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._loadingView = new _view_loading_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  init() {
    ...
    if (this._filterModel.filter === _const_js__WEBPACK_IMPORTED_MODULE_8__["FilterType"].STATISTICS) {
  ...
  _getFilms() {
    ...
    if (filterType === _const_js__WEBPACK_IMPORTED_MODULE_8__["FilterType"].STATISTICS) {
      filterType = _const_js__WEBPACK_IMPORTED_MODULE_8__["FilterType"].ALL;
    }

    const films = this._filmsModel.films;
    const filteredTasks = _utils_filter_js__WEBPACK_IMPORTED_MODULE_10__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].BY_DATE:
  ...
  _renderStats(films) {
    this._statisticsView = new _view_stats_js__WEBPACK_IMPORTED_MODULE_5__["default"](films);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._mainContainer, this._statisticsView.element, _const_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFORE_END);
  }
  ...
  _renderSorting() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._mainContainer, this._sortingView.element, _const_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFORE_END);
  }

  _renderFilmsContainer() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._mainContainer, this._filmsContainerView.element, _const_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFORE_END);
  }

  _renderNoFilms() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._mainContainer, this._noFilmView.element, _const_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFORE_END);
  }
  ...
  _renderLoadMoreButton() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._filmList, this._loadMoreButtonView.element, _const_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFORE_END);
  }
  ...
  _clearFilmList({resetRenderedTaskCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._noFilmView);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._loadingView);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._loadMoreButtonView);
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].MAJOR:
        ...
        this.init();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT:
...
const sortFilmByDate = (filmA, filmB) => {
  ...
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(filmB.releaseDate).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(filmA.releaseDate));
};
...
dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.extend(dayjs_plugin_isBetween__WEBPACK_IMPORTED_MODULE_1___default.a);
...
const countCompletedTaskInDateRange = (films, dateFrom, dateTo) => {
  return films.reduce((counter, film) => {
    ...
    if (
      dayjs__WEBPACK_IMPORTED_MODULE_0___default()(film.watchingDate).isSame(dateFrom) ||
...
const createFilterItemTemplate = (filter, currentFilterType) => {
  ...
  return `<a href="#${type}" data-type="${type}" class="main-navigation__item ${type === currentFilterType ? `main-navigation__item--active` : ``}">
    ${name} ${type === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL ? `` : `<span class="main-navigation__item-count">${count}</span>`}
  </a>`;
};
...
const createFilterTemplate = (filterItems, currentFilterType) => {
  ...
  return `<nav class="main-navigation">
    ...
    <a href="#stats" class="main-navigation__additional ${currentFilterType === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].STATISTICS ? `main-navigation__additional--active` : ``}">Stats</a>
  </nav>`;
};
...
class Filter extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setStatisticsClickHandler(callback) {
    ...
    statisticsButtons.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].MOUSE_DOWN, this._statisticsClickHandler);
    statisticsButtons.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].KEY_DOWN, this._statisticsClickHandler);
  }
  ...
  setFilterTypeChangeHandler(callback) {
    ...
    this._filterButtons.forEach((button) => {
      button.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].MOUSE_DOWN, this._filterTypeChangeHandler);
      button.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].KEY_DOWN, this._filterTypeChangeHandler);
    });
  }
}
        ...
        <section class="film-details__comments-wrap">
          ...
          <div class="film-details__new-comment">
            ...
            <label class="film-details__comment-label">
              <textarea class="film-details__comment-input" placeholder="Select reaction below and write comment here" name="comment">${he__WEBPACK_IMPORTED_MODULE_5___default.a.encode(commentInput)}</textarea>
            </label>
...
class Popup extends _smart__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  setCommentDeleteHandler(callback) {
    ...
    this._deleteButtons.forEach((button) => {
      button.addEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].MOUSE_DOWN, this._deleteCommentHandler);
      button.addEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].KEY_DOWN, this._deleteCommentHandler);
    });
  }
  ...
  removeCommentDeleteHandler(callback) {
    ...
    this._deleteButtons.forEach((button) => {
      button.removeEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].MOUSE_DOWN, this._deleteCommentHandler);
      button.removeEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].KEY_DOWN, this._deleteCommentHandler);
    });
  }
  ...
  setCommentAddHandler(callback) {
    ...
    this._commentField.addEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].KEY_DOWN, this._addCommentHandler);
  }

  removeCommentAddHandler(callback) {
    this._callback.addNewComment = callback;

    this._commentField.removeEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].KEY_DOWN, this._addCommentHandler);
  }
...
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
/* harmony import */ var _utils_stats__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/stats */ "./src/utils/stats.js");
...
class Profile extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    super();
    this._rank = Object(_utils_stats__WEBPACK_IMPORTED_MODULE_1__["getStats"])(films).rank;
  }
...
const createSortingTemplate = (currentSortType) =>
  `<ul class="sort">
    ...
    <li><a href="#" class="sort__button ${currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DATE ? `sort__button--active` : ``}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DATE}">Sort by date</a></li>
    <li><a href="#" class="sort__button ${currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_RATING ? `sort__button--active` : ``}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_RATING}">Sort by rating</a></li>
  </ul>`;
...
class Sorting extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setSortTypeChangeHandler(callback) {
    ...
    this.element.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].MOUSE_DOWN, this._sortTypeChangeHandler);
  }
}
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_stats_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/stats.js */ "./src/utils/stats.js");
...
const createDurationTemplate = (duration) => {
  const hours = Math.floor(duration / _const_js__WEBPACK_IMPORTED_MODULE_0__["SECONDS_IN_MINUTE"]);
  const minutes = Math.floor(duration % _const_js__WEBPACK_IMPORTED_MODULE_0__["SECONDS_IN_MINUTE"]);
  ...
  constructor(films) {
    ...
    this._data = {
      ...
      dateFrom: (() => {
        ...
        return dayjs__WEBPACK_IMPORTED_MODULE_2___default()().subtract(1, daysToFullWeek).toDate();
      })(),
      dateTo: dayjs__WEBPACK_IMPORTED_MODULE_2___default()().toDate()
    };
