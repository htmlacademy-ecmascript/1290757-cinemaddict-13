...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: PROPOSALS, ACTORS, MAX_DAYS, SECONDS_IN_MINUTE, RenderPosition, Event, Button */
...
/* harmony import */ var _view_no_film__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view/no-film */ "./src/view/no-film.js");
...
const loadMoreButtonElement = new _view_button_load_more_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
const renderFilm = (container, filmData) => {
  const filmElement = new _view_film_js__WEBPACK_IMPORTED_MODULE_4__["default"](filmData);

  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(container, filmElement.element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
const showMoreFilm = () => {
  ...
  if (renderedTaskCount >= films.length) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(loadMoreButtonElement);
  }
};
...
const showDetailFilm = (evt) => {
  popupElement = new _view_popup_js__WEBPACK_IMPORTED_MODULE_6__["default"](getDetailData(evt, body));

  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(body, popupElement.element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(header, new _view_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](stats).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"](filterData).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);

if (films.length) {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_sorting_js__WEBPACK_IMPORTED_MODULE_2__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_films_container_js__WEBPACK_IMPORTED_MODULE_3__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
} else {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(main, new _view_no_film__WEBPACK_IMPORTED_MODULE_8__["default"]().element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
}

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(footerStatistics, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_7__["default"](TOTAL_FILMS).element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
if (TOTAL_FILMS > MOVIES_PER_STEP) {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(filmList, loadMoreButtonElement.element, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFORE_END);
...
const generateFilm = () => {
  ...
  return {
    id: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(MAX_ID),
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: getFormatTime, render, createElement, remove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class LoadMoreButton extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setLoadMoreButtonHandler(callback) {
    ...
    this.element.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].MOUSE_DOWN, this._loadMoreButtonHandler);
    this.element.addEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].KEY_DOWN, this._loadMoreButtonHandler);
  }

  removeLoadMoreButtonHandler(callback) {
    this._callback.loadMore = callback;

    this.element.removeEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].MOUSE_DOWN, this._loadMoreButtonHandler);
    this.element.removeEventListener(_const_js__WEBPACK_IMPORTED_MODULE_1__["Event"].KEY_DOWN, this._loadMoreButtonHandler);
  }
}
...
class Film extends _abstract__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  setFilmHandler(callback) {
    ...
    this.element.addEventListener(_const__WEBPACK_IMPORTED_MODULE_3__["Event"].MOUSE_DOWN, this._filmHandler);
    this.element.addEventListener(_const__WEBPACK_IMPORTED_MODULE_3__["Event"].KEY_DOWN, this._filmHandler);
  }

  removeFilmHandler(callback) {
    this._callback.showDetail = callback;

    this.element.removeEventListener(_const__WEBPACK_IMPORTED_MODULE_3__["Event"].MOUSE_DOWN, this._filmHandler);
    this.element.removeEventListener(_const__WEBPACK_IMPORTED_MODULE_3__["Event"].KEY_DOWN, this._filmHandler);
  }
}
...
class Popup extends _abstract__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  setPopupHandler(callback) {
    ...
    this._closeButton.addEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].MOUSE_DOWN, this._popupHandler);
    this._closeButton.addEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].KEY_DOWN, this._popupHandler);
    document.addEventListener(_const__WEBPACK_IMPORTED_MODULE_2__["Event"].KEY_DOWN, this._popupHandler);
  }
